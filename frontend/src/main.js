...
pluralCaseList.push( {plural: "textData", pascal: "TextData"} )

pluralCaseList.push( {plural: "verificationResults", pascal: "VerificationResult"} )

pluralCaseList.push( {plural: "tenants", pascal: "Tenant"} )
